...
public class ArrayEnum {
    ...
    public ArrayEnum(int max){    //конструктор класса
        a = new long[max];          //создание массива размером max
        elem = 0;                  //при создании массив содержит 0 элементов
    }

    public void into(long value){   //метод вставки элемента в массив
        a[elem] = value;           //вставка value в массив a
    ...
    public static void main(String[] args) {
        ArrayEnum arrayEnum = new ArrayEnum(5);
